                        ...
                        <th>
                            <form method="post" action="adminthree.php">
                                <div class="w3-section">
                                    <button name="1 <?php echo ($row["id"]) ?>" class="w3-button w3-green" <?php echo ($row["admin_3"] == 1) ? 'disabled' : '' ?>>APPROVE</button>
                                    <button name="-1 <?php echo ($row["id"]) ?>" class="w3-button w3-red" <?php echo ($row["admin_3"] == -1) ? 'disabled' : '' ?>>REJECT</button>
                                </div>
                            </form>
                        </th>
                    </tr>
